...
class DataBase():
            ...
            with self.session_scope() as session, \
                ...
                if node.has_key('timestamp'):
                    ...
                    if len(timestamp_str) != 0 and timestamp_str != "-1":
                        ...
                        if DEBUG: print ("timestamp = %s" % (timestamp, ))
    ...
    def get_field(self, owner_name, field):
        """
        Given an owner name and a name of a field, return a list of entries
        with the id and field value.
        """
    ...
    def set_field(self, id, key, value):
        """
        Given an identifying id, set the specified key to the passed in value.
        """
