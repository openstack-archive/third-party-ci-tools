...
function invoke-fc-passthrough {
    ...
    #
    # Expect two parameters, the provider hostname (optionally user if needed)
    # and the file that should be sourced for OpenStack credentials
    #
    ...
    # asuming the group is the same name as the user...
